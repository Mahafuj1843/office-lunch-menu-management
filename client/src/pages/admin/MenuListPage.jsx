        ...
        <AppWrapper>
            <div className='w-[100vw] px-[1rem] md:px-[2rem] lg:px-[5rem] py-6 mt-16'>
                <div className='w-full lg:w-[90%] mx-auto lg:px-2'>
                    ...
                    <Pagination pageNo={pageNo + 1} perPage={perPage} total={20} handlePageClick={handlePageClick} />
                </div>
            </div>
        </AppWrapper>
    )
